...
#define QT_MOC_LITERAL(idx, ofs, len)                                                                                  \
	Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(                                                           \
		len,                                                                                                           \
		qptrdiff(offsetof(qt_meta_stringdata_CellButton_t, stringdata0) + ofs - idx * sizeof(QByteArrayData)))
static const qt_meta_stringdata_CellButton_t qt_meta_stringdata_CellButton = {
	{
		QT_MOC_LITERAL(0, 0, 10),	  // "CellButton"
		QT_MOC_LITERAL(1, 11, 13),	  // "middleClicked"
		QT_MOC_LITERAL(2, 25, 0)	  // ""

	},
	"CellButton\0middleClicked\0"
};
...
void CellButton::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
	...
	else if (_c == QMetaObject::IndexOfMethod)
	{
		int *result = reinterpret_cast< int * >(_a[0]);
		{
			...
			if (*reinterpret_cast< _t * >(_a[1]) == static_cast< _t >(&CellButton::middleClicked))
			{
				*result = 0;
				return;
			}
...
QT_INIT_METAOBJECT const QMetaObject CellButton::staticMetaObject = {
	{ QMetaObject::SuperData::link< QPushButton::staticMetaObject >(), qt_meta_stringdata_CellButton.data, qt_meta_data_CellButton, qt_static_metacall, nullptr, nullptr }
};
